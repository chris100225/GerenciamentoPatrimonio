...
public partial class GerenciamentoPatrimonioContext : DbContext
{
    public GerenciamentoPatrimonioContext()
    {
    }

    public GerenciamentoPatrimonioContext(DbContextOptions<GerenciamentoPatrimonioContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B8202823BA224E");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A779760577E642E").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623AC0CDDB8");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665ED608C1968");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DE8779C2CD").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B6800959339AA000");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462FF24B4D5F");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECAB8AC6EF7");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12BB6EC8FB7");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE08BE964F");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F33609A1BC1784");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1AAEB0FDA8").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B993C77B35");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1A290EF501").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0D68FD8911");
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C7029C20F6EE");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10AF02B1D75").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE7983703C722");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C8755AE782").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA2177301E5").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053481EA7B1F").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F897315F9F1FA6").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC3307FB6F6C1").IsUnique();
